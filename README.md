# MuxForge
## Description
MuxForge is a custom C++ library that provies a simplified interface for working with FFmpeg, FFplay, FFprobe, HandBrake, yt-dlp, and much more.
## Binaries
...
__Or__
> Download the installer file from the [Releases](https://github.com/codester2835/MuxForge/releases) page and run it.
...
## Usage
Once installed, you can use MuxForge from the command line. Run the followning command for options:
```
MuxForge help
```	
...
## Regarding FFmpeg
This project uses FFmpeg wich is licenced to the FFmpeg developers, speceficially [gyan.dev](https://www.gyan.dev/ffmpeg/builds/). The lincence is the [<u>Attribution-NonCommercial-NoDerivatives 4.0 International CC BY-NC-ND 4.0 Deed</u>](https://creativecommons.org/licenses/by-nc-nd/4.0/)

## Miscellaneous
1. You are free to distrubute this repository under any condition. 
